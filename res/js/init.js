...
var ${jAlbumGlobals} = (function () {
	...
	var slideMarginSize = ${slideMarginSize}; // Margin around full screen image.
	var style = "${style}";
...
var jAlbumInject = (function () {
	...
	inj('<div id="Responsive' + ${jAlbumGlobals}.uniqueId + '" class="jAlbum Responsive">'); // Responsive id surrounds all code of the body of the skin
	...
	inj('<script src="' + ${jAlbumGlobals}.jAlbumURL + 'main.js" type="text/javascript"></script>'); // includes skin controller
